...
import { dateFormatter, utils } from "@/src/utils/functions";
...
import EmptyTransactions from "@/src/modules/home/presentation/components/empty-transactions";
...
export interface TransactionsListProps {
  ...
  onPressTransaction: (item: ITransaction) => void;
  onEndReached: () => void;
